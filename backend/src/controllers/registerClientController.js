...
registerClient.insertClients = async (req, res) => {
    try {
        ...
        const newClient = clients({name, lastname, email, password: passwordHash, birthday, status, isVerified: isVerified || false, loginAttemps, timeOut})
